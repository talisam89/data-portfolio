# Flight Prices 
### Data Set
[Click here to view the Flight Prices dataset on Kaggle](https://www.kaggle.com/datasets/dilwong/flightprices?utm_source=chatgpt.com) data set created by Dillon Wong on Kaggle.
- 31.09 GB
- 27 fields
- 82,138,753 rows 
...
It should be noted that these conclusions only apply to nonstop flights in coach and were drawn using data from 2022. <img width="596" height="234" alt="image" src="https://github.com/user-attachments/assets/6d98a1c6-c789-4a18-b6bd-f1919f8c2d3c" />
